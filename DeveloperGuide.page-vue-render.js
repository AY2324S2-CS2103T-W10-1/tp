...
with(this){return _c('h3',{attrs:{"id":"filter-by-remarks-feature"}},[_v("Filter by Remarks feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#filter-by-remarks-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("FilterCommand: A command that, when executed, updates the filtered person list based on the predicate.")]),_v(" "),_c('li',[_v("RemarksContainsKeyphrasePredicate: Tests whether a person's remarks contain the given keyphrase.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User launches the application, and the list of persons is loaded.")]),_v(" "),_c('li',[_v("User executes filter r/Important, aiming to filter out persons with \"Important\" in their remarks.")]),_v(" "),_c('li',[_v("LogicManager parses the command into a FilterCommand with a RemarksContainsKeyphrasePredicate.")]),_v(" "),_c('li',[_v("The FilterCommand is executed, filtering the list based on the predicate.")]),_v(" "),_c('li',[_v("The UI reflects only those persons with \"Important\" in their remarks.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Alternative 1 (current choice): Support partial matches for remarks, similar to the \"Filter by Name\" feature.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Alternative 2: Match remarks exactly.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Realodex")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Fri, 29 Mar 2024, 14:35:11 GMT+8]")])])])}
}];
