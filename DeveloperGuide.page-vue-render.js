...
with(this){return _c('ul',[_c('li',[_v("FilterCommand: A command that, when executed, updates the filtered person list based on the predicate.")]),_v(" "),_c('li',[_v("NameContainsKeyphrasePredicate: A predicate that tests whether a person's name contains the given keyphrase.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("The user launches the application and the Model is initialized with the initial list of persons.")]),_v(" "),_c('li',[_v("The user executes the command filter n/John, intending to filter out persons whose names contain \"John\".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" parses the command, creating a FilterCommand with a NameContainsKeyphrasePredicate initialized with \"John\".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FilterCommand")]),_v(" is executed, using the predicate to filter the list of persons.")]),_v(" "),_c('li',[_v("The UI is updated to show only the persons whose names contain \"John\".")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Alternative 1 (current choice): Allow partial matches of names. For example, filter n/Jo will match \"John\", \"Joanna\", etc.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Thu, 4 Apr 2024, 13:03:40 GMT+8]")])])])}
}];
